                            ...
                            <form action="/admin/slider/update/{{ $slider->id }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        class="form-control text-white @error('title') is-invalid @enderror editable"
                                        id="desc" rows="5">{{ $slider->title }}</textarea>
                                        @error('title')
                                        ...
                                        @enderror
                                            {{-- <input type="text" name="title"
                                                ...
                                                aria-describedby="title" value="{{ $slider->title }}">
                                            @error('title')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control @error('bg_img') is-invalid @enderror" name="bg_img"
                                                ...
                                                style="max-height: 200px; max-width: 300px;" src="{{ asset('storage/' . $slider->bg_img) }}">
                                            @error('bg_img')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="row">
                                    <div class="mb-3">
                                        ...
                                        class="form-control text-white @error('sub_title') is-invalid @enderror editable"
                                        id="desc2" rows="5">{{ $slider->sub_title }}</textarea>
                                        @error('sub_title')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
